...
class ProvinceEndpoint extends AbstractEndpoint
{
    ...
    {
        $request = new GetJson('countries/' . $countryId . '/provinces.json', $query);
    ...
    {
        $request = new GetJson('countries/' . $countryId . '/provinces/' . $provinceId . '.json');
        $response = $this->send($request);
    ...
    {
        $request = new PutJson('countries/' . $countryId . '/provinces/' . $provinceId . '.json', array('province' => $province->toArray()));
        $response = $this->send($request);
        return $this->createEntity($response->get('province'));
    }
}
